package com.zhangeaky.se.serialize;
import java.io.*;
import com.zhangeaky.se.serialize.beans.computerRetailer;
import com.zhangeaky.se.serialize.beans.computer;
...
public class MuiltiSerializeDemo implements Serializable{
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        ObjectOutputStream out = new ObjectOutputStream(new FileOutputStream("com.zhangeaky.se.bean.txt"));
        ...
        ObjectInputStream in = new ObjectInputStream(new FileInputStream("com.zhangeaky.se.bean.txt"));
