package com.zhangeaky.se.jvm.classLoader;
...
public class ClassLoaderDeepUnderStanding {
    ...
    public static void main(String[] args) throws ClassNotFoundException, InstantiationException, IllegalAccessException {
        ...
        Class<?> aClass = loader.loadClass("com.zhangeaky.se.jvm.classLoader.tool");
    ...
    static class test {
        public static void main(String[] args) throws ClassNotFoundException {
            ...
            Class<?> aClass = classLoader.loadClass("com.zhangeaky.se.jvm.garbage.FinalizeEscape");
